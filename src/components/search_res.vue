    ...
    data () {
        return {
            ...
            genData: [ // 系谱档案
                ...
                { name: 'breedingSheepBase', fieldName: '种羊基地', fieldValue: '' },
                ...
                { name: 'typeName', fieldName: '品种名', fieldValue: '', size: 'large' },
                { name: 'remark', fieldName: '备注', fieldValue: '', size: 'large' }
            ],
            sanData: { // 卫生疫控
                welfare: [ // 卫生与动物福利操作档案
                    { fieldNameWidth: '60%', fieldValue: '', fieldName: '自检/主管上级检查时间', name: 'checkTime', size: 'large' },
                    { fieldValue: '', fieldName: '场内外环境卫生' ,size: 'large', noValue: true },
                    ...
                    { type: 'radio', fieldNameWidth: '60%', fieldValue: 0, fieldName: '杀虫灭鼠是否合格', name: 'killWormDeratization', size: 'large' },
                    { fieldValue: '', fieldName: '操作人员卫生与安全' ,size: 'large', noValue: true },
                    ...
                    { fieldValue: '', fieldName: '实验室卫生与安全' ,size: 'large', noValue: true },
                    ...
                    { type: 'radio', fieldNameWidth: '60%', fieldValue: 0, fieldName: '是否遵守操作规范', name: 'operationSpecification', size: 'large' },
                    ...
                    { type: 'radio', fieldNameWidth: '60%', fieldValue: 0, fieldName: '车辆进出是否消毒', name: 'carDisinfect', size: 'large' },
                ...
                disinfect: [ // 消毒实施档案
                    ...
                    { fieldName: '消毒方法', fieldValue: '', name: 'disinfectWay' },
                    { name: 'remark', fieldName: '备注', fieldValue: '', size: 'large' }
                ],
                immune: [ // 免疫实施档案
                    ...
                    { fieldName: '接种剂量(ml)', fieldValue: '', name: 'dose' },
                    { fieldName: '免疫期', fieldValue: '', name: 'immuneDuring', size: 'large' },
                    { name: 'remark', fieldName: '备注', fieldValue: '', size: 'large' }
                ],
                expelling: [ // 驱虫实施档案
                    { fieldName: '驱虫羊（群）', fieldValue: '', name: 'crowdNum'},
                    { fieldName: '耳牌附件号', fieldValue: '', name: 'repellentEartagFile' },
                    ...
                    { fieldName: '给药剂量(ml)', fieldValue: '', name: 'dose' },
                    { name: 'remark', fieldName: '备注', fieldValue: '', size: 'large' }
                ]
            },
            nutData: {
                stage: [ // 阶段营养实施档案
                    ...
                    { fieldName: '羊只均重/斤', fieldValue: '', name: 'average' },
                    { fieldName: '阶段', fieldValue: '', name: 'period' },
                    { fieldName: '预混料', name: 'materialA', fieldValue: ''},
                    { fieldValue: '', fieldName: '植料配方(%)' ,size: 'large', noValue: true },
                    { fieldName: '精料', name: 'materialM', fieldValue: ''},
                    { fieldName: '其他', name: 'materialO', fieldValue: ''},
                    { fieldValue: '', fieldName: '精料用量(体重%)' ,size: 'large', noValue: true },
                    { fieldName: '精料', name: 'materialWM', fieldValue: ''},
                    { fieldName: '其他', name: 'materialWO', fieldValue: ''},
                    { fieldValue: '', fieldName: '粗饲料配方(%)' ,size: 'large', noValue: true },
                    { fieldName: '青料', name: 'roughageP', fieldValue: ''},
                    { fieldName: '干料', name: 'roughageD', fieldValue: ''},
                    // { fieldName: '其他', name: 'roughageO', fieldValue: ''},
                    { fieldValue: '', fieldName: '粗饲料用量(体重%)' ,size: 'large', noValue: true },
                    { fieldName: '青料', name: 'roughageWP', fieldValue: ''},
                    { fieldName: '干料', name: 'roughageWD', fieldValue: ''},
                    { fieldName: '其他', name: 'roughageWO', fieldValue: '', size: 'large' },
                    { fieldName: '饮水', fieldValue: '', name: 'water', size: 'large' },
                    { fieldValue: '', fieldName: '领料总量' ,size: 'large', noValue: true },
                    { fieldName: '精料', name: 'pickingM', fieldValue: ''},
                    { fieldName: '粗饲料', name: 'pickingR', fieldValue: ''},
                    { fieldName: '其他', name: 'pickingO', fieldValue: '', size: 'large' },
                    { name: 'remark', fieldName: '备注', fieldValue: '', size: 'large' }
                ],
                hybrid: [ // 配种产子实施档案
                    ...
                    { fieldName: '产羔数量', fieldValue: '', name: 'quantity' },
                    { name: 'remark', fieldName: '备注', fieldValue: '', size: 'large' }

                ]
            },
            disData: [ // 疫病防治
                { fieldName: '日期', fieldValue: '', name: 'diagnosisTime', fieldNameWidth: '50%' },
                { fieldName: '栏号/栋数', fieldValue: '', name: 'buildingNum', fieldNameWidth: '50%' },
                { fieldName: '商标耳牌号', fieldValue: '', name: 'earTag', fieldNameWidth: '50%' },
                { fieldName: '观察检测分析症状', fieldValue: '', name: 'earTag', fieldNameWidth: '50%' },
                { fieldName: '诊断结果', fieldValue: '', name: 'diagnosisResult', fieldNameWidth: '50%' },
                { fieldName: '治疗方案及用药剂量', fieldValue: '', name: 'diagnosisMethod', fieldNameWidth: '50%' },
                // { fieldName: '监督确认时间', fieldValue: '', name: 'gmtSup' },
                { fieldName: '总用药量', fieldValue: '', name: 'dose', fieldNameWidth: '50%'},
                { fieldName: '诊断效果', fieldValue: '', name: 'treatEffect', fieldNameWidth: '50%' },
                { name: 'remark', fieldName: '备注', fieldValue: '', size: 'large', fieldNameWidth: '50%' }
            ],
            item: {
                name: '商品羊',
                erpai: '000000001',
